...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>襄阳市惠农谷信息服务平台-资源未找到</title>
		<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
		<meta http-equiv="Pragma" content="no-cache" />
		<meta http-equiv="Cache-Control" content="No-cache" />
		<script type="text/javascript" src="${base}/front/js/jquery-1.7.4.min.js" charset="UTF-8"></script>

<style rel="stylesheet">
img { border:none;}

/* 内容 */
.full{width:600px; position:absolute;top: 50%;left:50%;margin-left: -300px;margin-top: -200px;}
...
.full dl.error dd span.errortext500 img{width:200px; height:39px;  background:url(${base}/public/result/404/pic_bg.gif) -240px -375px no-repeat;}
...
<body leftmargin=0 topmargin=0 style="text-align: center;">
	<div class="full">
		<dl class="error">
			...
			<dd>
				<span class="error404">
					<img src="${base}/public/result/404/pic_dot.gif" alt="404" title="404" />
				</span>
				<span class="errortext404">
					<a href="#none" onclick="testMessageBox(event);">
