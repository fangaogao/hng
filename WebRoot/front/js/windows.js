...
xy_txt2 += '用户违反网站规则或其与惠农网签订的任何合同的行为，网站有权按照相应规则进行处理。<br />';
xy_txt2 += '<br />';
...
fxHtml_L+='                        <span><input name="" class="w-agree" type="checkbox" value="" />我同意以上协议，并已知晓相关的权利和义务</span>';
fxHtml_L+='                        <a href="javascript:void(0);" class="agree">关闭</a>';
fxHtml_L+='                    </td>';
fxHtml_L+='                </tr>';
fxHtml_L+='            </table>';
fxHtml_L+='        </div>';
